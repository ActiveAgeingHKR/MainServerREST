...
@NamedQueries({
    ...
    , @NamedQuery(name = "Employees.findIdByEmpName", query = "SELECT e.empId FROM Employees e WHERE e.empUsername = :empUsername")   
...
public class Employees implements Serializable {
    ...
    @JoinTable(name = "employee_has_tasks", joinColumns = {
        @JoinColumn(name = "employees_emp_id", referencedColumnName = "emp_id")}, inverseJoinColumns = {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "employeesEmpId")
    ...
    //autogenerated by wizard if allowed to run
    /*
    @XmlTransient
